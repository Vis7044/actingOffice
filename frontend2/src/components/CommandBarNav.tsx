...
export const CommandBarNav = () => {
  return (
    <div className={commandBarStyle}>
      ...
      {/* Right side */}
      <div className={sectionStyle}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, backgroundColor: '#fff', color: 'black', padding: '8px 10px', borderRadius: 4,border: "1px solid",borderColor: "rgba(0,0,0,0.2)", boxShadow: '0 1px 2px rgba(0, 0, 0, 0.1)' }}>
                      <FaSearch color='gray'  />
