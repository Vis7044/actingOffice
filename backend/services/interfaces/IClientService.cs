...
namespace backend.services.interfaces
{
    public interface IClientService
    {
        ...
        Task<PageResult<ClientModel>> GetClientsAsync(string role, string userId,int page, int pageSize, string searchTerm, string criteria, string value, string IsDeleted);
